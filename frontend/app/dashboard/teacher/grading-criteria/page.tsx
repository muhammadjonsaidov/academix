...
export default function TeacherGradingCriteriaPage() {
  ...
  return (
    <DashboardShell role="TEACHER">
      <TeacherNav />
      <h2 className="mb-4 text-lg font-semibold">Baholash mezonlari</h2>
      ...
      {subjectId ? (
        <div className="space-y-3">
                ...
                <tr key={i} className="border-b border-border">
                  ...
                  <td className="py-2 pr-2">
                    <input
                      ...
                      onChange={(e) =>
                        updateRow(i, { weightPercent: Number(e.target.value) })
                      }
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              className={`text-sm ${weightSum === 100 ? "text-muted-foreground" : "text-destructive"}`}
            >
              Jami: {weightSum}%
            </span>
          </div>
